...
import { Bars3Icon, HomeIcon, PhotoIcon, StarIcon } from "@heroicons/react/24/outline";
      ...
      <div className="navbar-start w-auto xl:w-1/2">
        ...
        <Link href="/" passHref className="hidden xl:flex items-center gap-1 ml-4 mr-6 shrink-0">
          ...
          <div className="flex flex-col">
            <span className="font-bold leading-tight">Robotz Collection</span>
            <span className="text-xs">Official NFT Shop</span>
          </div>
        </Link>
